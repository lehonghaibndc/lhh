...
<div class="color">
    ...
    <form class="form-horizontal" action="SendPassNew">
        <div class="form-group">
            <table width="100%">
                <tr>
                ...
                <tr>
                    <td width="50%"><label class="col-sm-2 control-label" for="User"
                                           style="width: 50%;">Chức Vụ :</label></td>
                    <td width="50%"><select name="position1" style="width: 50%;margin-left: 15px">

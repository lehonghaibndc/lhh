...
<div class="color">
    <div class="container">
        ...
        <form class="form-horizontal" action="confirm.jsp">
            <h3>Mật khẩu mới đã được gửi tới gmail của bạn,vui lòng kiểm tra Gmail của bạn để tiếp tục truy cập.</h3>
            <div class="form-group" align="center">
                <a href="Form.jsp" style="width: 100%">Quay Về Trang Chủ</a>
            </div>
        </form>

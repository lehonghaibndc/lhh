        ...
        <div class="head">
            ...
            <div class="namewed">
                ...
                <div class="btn-group btn-group-justified">
                    ...
                    <a href="#" class="btn btn-primary">Tư vấn SV</a> <a href="#" class="btn btn-primary">Liên hệ</a> <a href="Form.jsp" class="btn btn-primary">Thoát</a>
                </div>
            </div>
        </div>
        <hr width="90%" size="10px" align="center" />
        <div align="center"><h2>Sơ Đồ Tổ Chức</h2></div>
        <div><img src="/libs/SDTC.jpg" style="width: 750px; height: 500px"
                  align="left"> </div>
        <hr width="90%" size="10px" align="center"/>
